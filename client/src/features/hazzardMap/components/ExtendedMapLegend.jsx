...
export const ExtendedMapLegend = ({ setFilteredHazardTypes }) => {
  ...
  const toggleHazardType = (typeId) => {
    ...
    if (showAllHazards) {
      // If all are currently shown, then show only the clicked type
  ...
  return (
    <Paper sx={{ 
      ...
      {/* Hazard type legends - now clickable */}
