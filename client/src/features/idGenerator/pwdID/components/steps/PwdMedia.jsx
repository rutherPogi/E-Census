  ...
  useEffect(() => {
    ...
    if (formData.pwdMedia) {
      if (formData.pwdMedia.photoID) {
        ...
        if (formData.pwdMedia.photoID instanceof File) {
          setImagePreviews(prev => ({ 
            ...prev, photoID: URL.createObjectURL(formData.pwdMedia.photoID) 
          }));
        }
      }
      ...
      if (formData.pwdMedia.signature) {
        ...
        if (formData.pwdMedia.signature instanceof File) {
          setImagePreviews(prev => ({ 
            ...prev, signature: URL.createObjectURL(formData.pwdMedia.signature) 
          }));
        }
      }
    }
