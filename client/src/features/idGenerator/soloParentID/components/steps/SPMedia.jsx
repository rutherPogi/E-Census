  ...
  useEffect(() => {
    if (formData.spMedia) {
      if (formData.spMedia.photoID) {
        ...
        if (formData.spMedia.photoID instanceof File) {
          setImagePreviews(prev => ({ 
            ...prev, photoID: URL.createObjectURL(formData.spMedia.photoID) 
          }));
        }
      }
      ...
      if (formData.spMedia.signature) {
        ...
        if (formData.spMedia.signature instanceof File) {
          setImagePreviews(prev => ({ 
            ...prev, signature: URL.createObjectURL(formData.spMedia.signature) 
          }));
        }
      }
    }
